...
class Translate extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_word, translate, id_set', 'required'),
			array('id_word', 'numerical', 'integerOnly'=>true),
			array('translate', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_word, translate', 'safe', 'on'=>'search'),
		);
	}
